<?php  $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'anioPlan',array('class'=>'span1')); ?>

	<?php echo $form->textFieldRow($model,'Carrera_id',array('class'=>'span5')); ?>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","#search-plan-form").each(function() {
		var type = this.type;
