...
<div id="container_Mat_Tabla">
    <!-- <span>Materias</span> -->
    <div id="materias" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
    ...
    <div id="tabla">
        <table class="tg-table-light">
            ...
            <tr>
                <td id="c1" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
                <td id="c2" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
            </tr>
            <tr class="tg-even">
            ...
            <tr>
                <td id="c3" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
                <td id="c4" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
            </tr>
            <tr class="tg-even">
            ...
            <tr>
                <td id="c5" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
                <td id="c6" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
            </tr>
            <tr class="tg-even">
            ...
            <tr>
                <td id="c7" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
                <td id="c8" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
            </tr>
            <tr class="tg-even">
            ...
            <tr>
                <td id="c9" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
                <td id="c10" class="drop" ondrop="dropMateria(this, event)" ondragenter="return false"
                    ondragover="return false"></td>
            </tr>
        </table>
    </div>
...
<script type="text/javascript">
    $( document ).ready(function() {
        <?php echo Yii::app()->controller->onloadFunction; ?>
    });
